...
class Rental {
    ...
    public Rental() {
        ...
        carImages.put("Maruti Alto", new ImageIcon("maruti_alto.jpeg")); 
        carImages.put("Tata Nexon", new ImageIcon("tata_nexon.jpeg")); 
        carImages.put("Hyundai i20", new ImageIcon("hyundai_i20.jpeg")); 
        carImages.put("Mahindra Thar", new ImageIcon("mahindra_thar.jpeg")); 
        carImages.put("Audi Q7", new ImageIcon("audi_q7.jpeg")); 
    }
    ...
    void rent_a_car() {
        ...
        JOptionPane.showMessageDialog(null, "You are renting the " + car.getCarName() + " car.\n" +
                ...
                "The total cost of the car is: " + car.getRentalCostPerDay() * m + " only." + "your car Id is :" + car.getCarId());
...
public class CarRentalSystem {
    public static void main(String[] args) {
        ...
        ImageIcon background = new ImageIcon("lamboo.jpeg", "CAR RENTAL SYSTEM");
